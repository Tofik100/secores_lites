						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Sub Resellers Dashboard
									<!--begin::Separator-->
...
<rect x="3" y="13" width="3" height="6" rx="1.5" fill="black"/>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-primary fw-bold fs-6">Total Inventory</a>
														</div>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-success fw-bold fs-6 mt-2">Total Resellers </a>
														</div>
														<!--end::Col-->
													...
													<rect opacity="0.3" x="8" y="3" width="8" height="8" rx="4" fill="black"></rect>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-success fw-bold fs-6 mt-2">Total Sub Resellers</a>
														</div>
													</div>
													<!--end::Row-->
													<!--begin::Row-->
...
<path d="M20.1 6.65L12.3 2.15C12 1.95 11.6 1.95 11.3 2.15L3.5 6.65C3.2 6.85 3 7.15 3 7.45V16.45C3 16.75 3.2 17.15 3.5 17.25L11.3 21.75C11.5 21.85 11.6 21.85 11.8 21.85C12 21.85 12.1 21.85 12.3 21.75L20.1 17.25C20.4 17.05 20.6 16.75 20.6 16.45V7.45C20.6 7.15 20.4 6.75 20.1 6.65ZM5 15.85V7.95L11.8 4.05L18.6 7.95L11.8 11.95V19.85L5 15.85Z" fill="black"/>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-success fw-bold fs-6">Total Distributors</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
...
<path d="M16 12C16 14.2 14.2 16 12 16C9.8 16 8 14.2 8 12C8 9.8 9.8 8 12 8C14.2 8 16 9.8 16 12ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z" fill="black"/>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-warning fw-bold fs-6">Total Suspended</a>
														</div>
                                                                                                                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															<!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
															<span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
													...
													<rect opacity="0.3" x="8" y="3" width="8" height="8" rx="4" fill="black"></rect>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-warning fw-bold fs-6 mt-2">Total Inactive </a>
														</div>
														<!--end::Col-->
...
<path opacity="0.5" d="M9 4C9 3.44772 9.44772 3 10 3H14C14.5523 3 15 3.44772 15 4V4H9V4Z" fill="black"/>
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-danger fw-bold fs-6 mt-2">Deleted Requests</a>
														</div>
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="d-flex justify-content-start flex-column">
																			...
																			<span class="text-muted fw-bold text-muted d-block fs-7">ana@gmail.com</span>
																		</div>
																	</div>
																</td>
																<td>
																	<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">Intertico</a>
																	<span class="text-muted fw-bold text-muted d-block fs-7">Transports</span>
																</td>
																<td class="text-end">
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="d-flex justify-content-start flex-column">
																			...
																			<span class="text-muted fw-bold text-muted d-block fs-7">jessie@gmail.com</span>
																		</div>
																	</div>
																</td>
																<td>
																	<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">Agoda</a>
																	<span class="text-muted fw-bold text-muted d-block fs-7">Logistics</span>
																</td>
																<td class="text-end">
																	<div class="d-flex flex-column w-100 me-2">
																		Oct 13, 2021
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="d-flex justify-content-start flex-column">
																			...
																			<span class="text-muted fw-bold text-muted d-block fs-7">lebron@hotmail.com</span>
																		</div>
																	</div>
																</td>
																<td>
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="d-flex justify-content-start flex-column">
																			...
																			<span class="text-muted fw-bold text-muted d-block fs-7">natali@hotmail.com</span>
																		</div>
																	</div>
																</td>
																<td>
																	<a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">The Hill</a>
																	<span class="text-muted fw-bold text-muted d-block fs-7">Shipments Pvt Ltd</span>
																</td>
																<td class="text-end">
																	<div class="d-flex flex-column w-100 me-2">
																		Oct 13, 2021
