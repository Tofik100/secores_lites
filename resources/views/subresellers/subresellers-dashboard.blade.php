                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    @if (session()->has('message'))
                        <div class="alert alert-success">
                            <h4 class="text-sm text-center">{{ session('message') }}</h4>
                        </div>
                    @endif

                    @if (session()->get('user'))
                        <div class="alert alert-success">
                            <h4 class="text-sm text-center">{{ session()->get('user') }}</h4>
                        </div>
                    @endif
                    @can('write post')
                        <div class="row ">
							<div class="col-md-3 ">
								<a href="{{ route('subPost') }}">
									<button class="btn btn-success my-2 mx-5">
									Create Post
									</button>
								</a>
							</div>
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Sub Resellers
                                    Dashboard
                                    <!--begin::Separator-->
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_615c3b188f30c"
                                ...
                                <div class="col-xl-8">
                                    ...
                                    <div class="card card-xl-stretch">
                                        ...
                                        <div class="card-body p-0">
                                            <!--begin::Chart-->
                                            <div class="mixed-widget-2-chart card-rounded-bottom bg-primary"
                                            ...
                                            <div class="card-p mt-n20 position-relative">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-primary fw-bold fs-6">Total Users</a>
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                                                    <div class="col bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-primary fw-bold fs-6">Total
                                                            Inventory</a>
                                                    </div>
                                                    <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-success fw-bold fs-6 mt-2">Total
                                                            Resellers </a>
                                                    </div>
                                                    <!--end::Col-->
                                                    <div class="col bg-light-success px-6 py-8 rounded-2 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-success fw-bold fs-6 mt-2">Total Sub
                                                            Resellers</a>
                                                    </div>
                                                </div>
                                                <!--end::Row-->
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-success fw-bold fs-6">Total
                                                            Distributors</a>
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-warning fw-bold fs-6">Total
                                                            Suspended</a>
                                                    </div>
                                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-warning fw-bold fs-6 mt-2">Total
                                                            Inactive </a>
                                                    </div>
                                                    <!--end::Col-->
                                                    <div class="col bg-light-danger px-6 py-8 rounded-2 mb-7">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a href="#" class="text-danger fw-bold fs-6 mt-2">Deleted
                                                            Requests</a>
                                                    </div>
                                                ...
                                                <table
                                                    ...
                                                    <thead>
                                                        <tr class="fw-bolder text-muted">
                                                            ...
                                                            <th class="min-w-120px">Date of Joining</th>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="#"
                                                                            ...
                                                                            Simmons</a>
                                                                        <span
                                                                            class="text-muted fw-bold text-muted d-block fs-7">ana@gmail.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="text-muted fw-bold text-muted d-block fs-7">Transports</span>
                                                            </td>
                                                            <td class="text-end">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="#"
                                                                            ...
                                                                            Clarcson</a>
                                                                        <span
                                                                            class="text-muted fw-bold text-muted d-block fs-7">jessie@gmail.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="text-muted fw-bold text-muted d-block fs-7">Logistics</span>
                                                            </td>
                                                            <td class="text-end">
                                                                <div class="d-flex flex-column w-100 me-2">
                                                                    Oct 13, 2021
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="#"
                                                                            ...
                                                                            Wayde</a>
                                                                        <span
                                                                            class="text-muted fw-bold text-muted d-block fs-7">lebron@hotmail.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="#"
                                                                            ...
                                                                            Goodwin</a>
                                                                        <span
                                                                            class="text-muted fw-bold text-muted d-block fs-7">natali@hotmail.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="#"
                                                                    ...
                                                                    Hill</a>
                                                                <span
                                                                    class="text-muted fw-bold text-muted d-block fs-7">Shipments
                                                                    Pvt Ltd</span>
                                                            </td>
                                                            <td class="text-end">
                                                                <div class="d-flex flex-column w-100 me-2">
