...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Plan List
									<!--begin::Separator-->
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												...
												<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
													<a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#create_plan">
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
														...
														<thead>
															<tr class="fw-bolder text-muted">
																...
																<th class="min-w-140px">1 Month</th>
																<th class="min-w-140px">3 Months</th>
																<th class="min-w-140px">6 Months</th>
																<th class="min-w-140px">1 Year</th>
																<th class="min-w-120px">Activation Date</th>
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-200px" src="{{ url('assets/media/demos/demo1.png') }}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-200px" src="{{ url('assets/media/demos/demo3.png') }}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
		...
		<div class="modal fade" id="create_plan" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							<!--begin::Title-->
							<h1 class="mb-3">Create a plan</h1>
							<!--end::Title-->
						</div>
						<!--end::Heading-->
						<!--begin::Textarea-->
                                                <label>Select any one of three</label>
						...
						<div class="d-flex flex-stack">
							<!--begin::Label-->
							<div class="btn btn-primary fw-bolder w-100 mb-8 mt-10">
                                                        Save</div>
							<!--end::Switch-->
						</div>
						<!--end::Notice-->
