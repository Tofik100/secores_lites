<?php $base_url = "http://localhost/xways/dist/"; ?>
<!DOCTYPE html>
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Users List | Secore</title>
		<meta charset="utf-8" />
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Users List
									<!--begin::Separator-->
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
														...
														<thead>
															<tr class="fw-bolder text-muted">
																...
																<th class="">Screen Name Call</th>
																<th class="min-w-150px">User Type</th>
																<th class="min-w-140px">ECC ID</th>
																<th class="min-w-120px">Activation Date</th>
																<th class="min-w-120px">License Period</th>
																<th class="min-w-120px">Plan Type</th>
